...
class SysPerAPI():
    ...
    def cls(self) -> int:
        try:
            ...
            print(Fore.RED + f'MayDOS/ROOT/ERROR>>>{e}')
            return 400
    ...
    def CreatSysFile(self,path : str = '',context : str = 'Test') -> int:
        try:
            if self.Per == 'sys':
                ...
                print(Fore.YELLOW + f'Insufficient permissions')
                return 201
            else:
                print(Fore.YELLOW + f'Unknown permissions: {self.Per}')
                return 202
        except Exception as e:
            print(Fore.RED + f'MayDOS/Root/ERROR>>>{e}')
            return 400
...
while True:
    ...
    if cmd == 'calc' or cmd == 'CALC':
        os.system('python important/Applications/calc.py')

    elif cmd[0:3] == 'sof' or cmd[0:3] == 'SOF':
        try:
            if cmd[4:-1] == 'json':
    ...
    elif cmd[0:6] == 'SEARCH' or cmd[0:6] == 'search':
    ...
    elif cmd == 'usebook' or cmd == 'USEBOOK' or cmd == 'HELP' or cmd == 'help':
    ...
    elif cmd == 'close' or cmd == 'CLOSE':
        quit()

    elif cmd == 'MENU' or cmd == 'menu':
        pass

    elif cmd == 'SHUT' or cmd == 'shut':
    ...
    elif cmd == 'notepad' or cmd == 'NOTEPAD':
        try:
            ENCO_FILE = 'w'
            print('\n选择编辑模式 -->')
            print('1.正常写入')
    ...
    elif cmd == 'explorer' or cmd == 'EXPLORER':
        try:
            SysPerAPI().cls()
